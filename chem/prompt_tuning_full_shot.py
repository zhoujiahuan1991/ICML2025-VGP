...
def main():
    ...
    # model_param_group.append({"params": model.parameters()}) # full fine-tuning
    ...
    test_acc_list = []
    best_test_acc = -1
    with open(f'{args.tuning_type}-{args.dataset}-fullshot-result.log', 'a+') as f:
    ...
    for epoch in range(1, args.epochs+1):
        ...
        with open(f'{args.tuning_type}-{args.dataset}-fullshot-result.log', 'a+') as f:
            ...
            if test_acc > best_test_acc:
                ...
                f.write(f"==========Best Test Acc {best_test_acc*100}%==========\n")
