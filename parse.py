...
import argparse
import yaml
# The first arg parser parses out only the --config argument, this argument is used to load a yaml file containing key-values that override the defaults for the main parser below
config_parser = parser = argparse.ArgumentParser(description='Training Config', add_help=False)
parser.add_argument('-c', '--config', type=str, metavar='FILE', help='YAML config file specifying default arguments')
...
parser.add_argument('--mixup', type=float, default=0.8, help='mixup alpha, mixup enabled if > 0. (default: 0.)') #0.8
...
parser.add_argument('--weight-decay', type=float, default=0.005, # 0.05 0.0005
...
parser.add_argument('--warmup-lr', type=float, default=0.000010, metavar='LR',
                    help='warmup learning rate (default: 0.0001)')
parser.add_argument('--min-lr', type=float, default=0.000001, metavar='LR', #0.000001
...
# Hyperparameters for loss and networks
parser.add_argument('--smoothing', type=float, default=0.1, help='Label smoothing (default: 0.1)')
parser.add_argument('--drop-rate', type=float, default=0.3, help='Dropout rate (default: 0.)')
parser.add_argument('--drop-path', type=float, default=0.1, help='Drop path rate (default: None)')
...
parser.add_argument("--evaluate", action='store_true', default=False, help='whether evaluate the model')
