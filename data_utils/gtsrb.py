...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default="/data/ckpt/aizixiang/vig_prompt/data")
    parser.add_argument('--crop_size', type=int, default=224)
    parser.add_argument('--num_classes', type=int, default=43)
    args = parser.parse_args()

    dataset_train = GTSRB(args.data_dir, "train")
    dataset_val = GTSRB(args.data_dir, "val")
    dataset_test = GTSRB(args.data_dir, "test")
