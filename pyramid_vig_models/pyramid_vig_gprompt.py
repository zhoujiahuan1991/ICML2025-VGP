...
class Gprompt(torch.nn.Module):
    def __init__(self, input_dim):
        ...
        self.weight = torch.nn.Parameter(torch.Tensor(1,input_dim,1,1))
...
class Grapher(nn.Module):
    ...
    def __init__(self, in_channels, kernel_size=9, dilation=1, conv='edge', act='relu', norm=nn.LayerNorm,
        ...
        self.gprompt = Gprompt(self.channels)
...
@register_model
def pvig_gprompt_ti_224_gelu(pretrained=False, **kwargs):
    class OptInit:
...
@register_model
def pvig_gprompt_s_224_gelu(pretrained=False, **kwargs):
    class OptInit:
        def __init__(self, num_classes=1000, drop_path_rate=0.0, **kwargs):
            self.k = 9 # neighbor num (default:9)
            self.conv = 'mr' # graph conv layer {edge, mr}
...
@register_model
def pvig_gprompt_m_224_gelu(pretrained=False, **kwargs):
    class OptInit:
        def __init__(self, num_classes=1000, drop_path_rate=0.0, **kwargs):
            self.k = 9 # neighbor num (default:9)
            self.conv = 'mr' # graph conv layer {edge, mr}
...
@register_model
def pvig_gprompt_b_224_gelu(pretrained=False, **kwargs):
    class OptInit:
        def __init__(self, num_classes=1000, drop_path_rate=0.0, **kwargs):
            self.k = 9 # neighbor num (default:9)
            self.conv = 'mr' # graph conv layer {edge, mr}
