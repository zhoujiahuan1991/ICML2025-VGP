...
def main():
    ...
    test_acc_hard_mean = []
    test_acc_hard_std = []
    with open(f'{args.tuning_type}-fullshot-result.log', 'a+') as f:
        f.write(f'\n\n====================================\n')
    ...
    with open(f'{args.tuning_type}-fullshot-result.log', 'a+') as f:
        ...
        f.write('best_epoch_easy='+str(best_epoch_easy+1)+'\n')
        f.write('best_epoch_hard='+str(best_epoch_hard+1)+'\n')
