...
class GreedyViG(torch.nn.Module):
    ...
    def load_model_from_ckpt(self, ckpt_path, logger=None):
        ...
        print(f'[Greedy ViG] Successful Loading the ckpt from {ckpt_path}')

@register_model
def greedy_vig_s(pretrained=False, **kwargs): ## 12.0 M, 1.6 GMACs
...
@register_model
def greedy_vig_m(pretrained=False, **kwargs): # 21.9 M, 3.2 GMACs
...
@register_model
def greedy_vig_b(pretrained=False, **kwargs): # 30.9 M, 5.2 GMACs
